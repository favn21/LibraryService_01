...
public void testGetBooksByAuthorJSON() {
    ...
    List<GetBooksByAuthorResponse.BookDetail> expectedBooks = Collections.emptyList();
    ...
    public void testGetBooksByAuthorWithoutId() {
        ...
        BaseResponse  response = ErrorBookApiRequests.getBooksByAuthorWithError(0L, 400);
